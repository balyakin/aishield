...
func newRootCommand() *cobra.Command {
	...
	rootCommand.AddCommand(newScanCommand())
	rootCommand.AddCommand(newExportCommand())
	rootCommand.AddCommand(newRetentionCommand())
	rootCommand.AddCommand(newDashboardCommand())
